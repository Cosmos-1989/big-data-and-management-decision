...
function homePage(){
 ...
 main.insertAdjacentHTML('beforeend',`<div class="chapter-list">${catalog.chapters.filter(c=>/^\d/.test(c.id)).map(chapterLink).join('')}</div><h2 id="reading">如何使用本课程</h2><ol class="reading-steps"><li><strong>阅读问题、定义与算例。</strong>先界定业务对象、时间窗口、指标口径和可行行动，再选择方法。</li><li><strong>在实验室验证。</strong>修改参数或源代码，运行课程 Python 与 SQL，观察表格和图形如何变化。</li><li><strong>解释结果与边界。</strong>结合章末习题、作业和报告模板，说明统计证据、管理含义及假设条件。</li></ol><div class="home-links"><a href="#/chapter/syllabus">课程大纲 →</a><a href="#/resources">作业与数据 →</a><a href="./downloads/bdm_textbook.pdf" target="_blank">下载教材 PDF ↓</a></div>${footer()}`);
 setToc([{title:'阅读与实践',href:'#/?anchor=practice'},{title:'课程内容',href:'#/?anchor=chapters'},{title:'使用指南',href:'#/?anchor=reading'}]);
}
function typeset(){
